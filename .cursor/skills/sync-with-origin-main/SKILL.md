...
- **`CONTRIBUTING.md`** — start with *Collaboration, Git, and environment* (Phase A / B), *Commit messages (GitHub handle prefix)* (`[apalmer]`-style subjects), Node.js, CI, and Profile Viewer canonical path.
