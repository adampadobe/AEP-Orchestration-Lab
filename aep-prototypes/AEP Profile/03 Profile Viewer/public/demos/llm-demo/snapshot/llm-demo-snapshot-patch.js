...
(function () {
  ...
  function snapshotBuild() {
    return (typeof window !== 'undefined' && window.LLM_DEMO_SNAPSHOT_BUILD) || '20260619';
  }
  ...
  function runLlmDemoPatches() {
    ...
    function boot() {
      ...
      loadScript('./llm-demo-snapshot-llm-demo-urls.js', afterUrls);
    }
    ...
    loadScript('./llm-demo-snapshot-llm-demo-brands.js', boot);
  }
