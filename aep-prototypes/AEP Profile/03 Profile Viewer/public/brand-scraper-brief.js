...
(function (global) {
  ...
  function generateScrapeBrief(opts) {
    ...
    return [
      ...
      '---',
      '',
      '## Manual webpage capture tools',
      '',
      '- **[SingleFile](https://www.getsinglefile.com/)** — recommended. Saves a complete webpage, including images, styles and fonts, as one upload-ready `.html` file.',
      '- **[html.to.design](https://chromewebstore.google.com/detail/htmltodesign/ldnheaepmnmbjjjahokphckbpgciiaed?hl=en)** — captures a webpage for Figma or clipboard-based design workflows. Use SingleFile when you need a standard HTML upload.',
      '- **Chrome Save As → Webpage, Complete** — use this when you want an HTML file plus a separate asset folder; zip both together before upload.',
      '',
      'Open the page you need, let it finish loading, run your chosen capture tool, then return to **Brand Scraper → Scrape blocked? Offline fallback**.',
      '',
      '---',
      '',
  ...
  function generateAssetChecklist(opts) {
    ...
    return [
      ...
      '## Manual tools',
      '',
      '- **[SingleFile](https://www.getsinglefile.com/)** — recommended for one upload-ready `.html` file',
      '- **[html.to.design](https://chromewebstore.google.com/detail/htmltodesign/ldnheaepmnmbjjjahokphckbpgciiaed?hl=en)** — visual/Figma capture; not a standard HTML export',
      '- Chrome **Save As → Webpage, Complete** — zip the HTML and asset folder together',
