...
(function (global) {
  ...
  function run() {
    ...
    if (facebookHomeTagsInjection && window.envBar && typeof window.envBar.registerTagsInjection === 'function') {
      window.envBar.registerTagsInjection(facebookHomeTagsInjection);
    }
