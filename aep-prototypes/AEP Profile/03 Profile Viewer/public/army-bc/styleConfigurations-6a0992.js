window.styleConfiguration = {
  ...
  "text": {
    ...
    "input.placeholder": "What type of role do you want to search for?",
  ...
  "arrays": {
    "welcome.examples": [
      {
        "text": "About the Army",
        "systemPrompt": "The user selected About the Army. Give a concise overview of the British Army as the land warfare branch of UK Armed Forces: career opportunities, training, teamwork, and service at home and overseas. List 3–4 key aspects of Army life. End with a short question about their interests (combat, technology, leadership, engineering). Offer exactly 3 follow-up prompt suggestions, including one about career progression in Army engineering roles.",
      ...
      {
        "text": "Army Life",
        "systemPrompt": "The user selected Army Life. Describe daily life, training, welfare, and development in the British Army. Be factual, supportive, and concise. Offer 3 follow-up prompt suggestions about training, benefits, or finding a suitable role.",
      ...
      {
        "text": "Events",
        "systemPrompt": "The user selected Events. Explain how to learn more through Army recruitment events and official jobs.army.mod.uk channels. Offer 3 follow-up prompt suggestions about attending events or exploring roles online.",
