/**
 * Prepares Opportunities saved HTML + copies Op assets into demos/llm-demo/snapshot/assets/.
 */
import fs from 'node:fs';
import path from 'node:path';
import { fileURLToPath } from 'node:url';
import { applyOpportunitiesBranding } from './llm-demo-snapshot-sky-text.mjs';
...
const SNAPSHOT_ASSETS = [
  ...
  '<link rel="stylesheet" href="./llm-demo-snapshot-opportunities.css">',
  ...
  '<script src="./llm-demo-snapshot-opportunities.js"></script>',
].join('\n');
