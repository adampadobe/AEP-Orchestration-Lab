...
const ADOBE_API_CAPABILITIES = Object.freeze([
  ...
  capability('lightroom', 'Adobe Lightroom API', 'creative', ['openid', 'AdobeID', 'read_organizations'], 3, 'write-capable', ['Use Photoshop API v2 for combined auto tone, auto straighten, light, and colour edits', 'Prepare approved image renditions']),
  ...
  capability('photoshop', 'Adobe Photoshop API', 'creative', ['openid', 'AdobeID', 'read_organizations'], 3, 'billable', ['Apply production image edits and unified Lightroom-style adjustments', 'Create channel crops and template-driven variants']),
  ...
  capability('express-review', 'Adobe Express Review API', 'creative', [], 4, 'unverified', ['Connected in Developer Console; wait for a verified public operation contract before building', 'Keep review-state orchestration separate from Express template production']),
  ...
  capability('substance-3d', 'Adobe Substance 3D API', 'creative', ['firefly_api', 'firefly_enterprise', 'substance3d_api.jobs.create', 'substance3d_api.spaces.create'], 3, 'billable', ['Create 3D product visualization workflows', 'Generate reusable product-scene assets']),
