/**
 * Persist AEP Lab Telecommunications Profile streaming + infra IDs per
 * Adobe sandbox (Firestore). Thin config wrapper around
 * `profileConnectionStoreFactory`.
 *
...
const COLLECTION = 'telecomProfileConnections';
