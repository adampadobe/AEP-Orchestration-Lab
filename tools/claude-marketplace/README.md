...
The plugin installs `aep-lab-general` (the complete 201-tool catalog) plus the fifteen focused connections, including governed Adobe Commerce, Commerce Optimizer, Firefly creative media, and the Adobe Creativity production API group. Prefer a focused connection for ordinary tasks and General for advanced or cross-domain workflows.
