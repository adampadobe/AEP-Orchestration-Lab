...
The plugin installs `aep-lab-general` (the complete 164-tool catalog) plus the twelve focused connections, including governed Adobe Commerce, Commerce Optimizer, and Firefly Image 5 generation. Prefer a focused connection for ordinary tasks and General for advanced or cross-domain workflows.
