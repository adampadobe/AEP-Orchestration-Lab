...
The plugin installs `aep-lab-general` (the complete 159-tool catalog) plus the eleven focused connections, including governed Adobe Commerce and Commerce Optimizer catalog preparation. Prefer a focused connection for ordinary tasks and General for advanced or cross-domain workflows.
