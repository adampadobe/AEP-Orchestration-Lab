...
Fourteen MCP connections: the complete General catalog plus thirteen focused capabilities:

| Connection | Endpoint | Purpose |
|---|---|---|
| `aep-lab-entry` | `/mcp/entry` | Capability directory and workflow recommender |
| `aep-lab-general` | `/mcp` | Complete 167-tool catalog, including advanced onboarding, infrastructure, Snowflake, Commerce, Commerce Optimizer, Firefly, Adobe API discovery, and administration |
...
| `aep-lab-firefly` | `/mcp/firefly` | Governed Firefly Image 5 text-to-image generation, async job status, and cancellation |
