...
| `/mcp/decisioning` | 19 | Capabilities inventory, Edge evaluation, explanation, treatment resolution, catalog health, governed create/update/delete plus async bulk migration and cloning across all seven entity types (adds tags), compound builders for ranking formulas and selection strategies, and offer-level eligibility attach/detach |
