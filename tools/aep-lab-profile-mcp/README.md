...
| `/mcp/decisioning` | 15 | Capabilities inventory, Edge evaluation, explanation, treatment resolution, catalog health, and governed create/update/delete plus async bulk migration across offer-items, item-collections, selection-strategies, eligibility rules, ranking formulas, and placements |
