...
export const MCP_CONTEXTS = Object.freeze([
  ...
  },
  {
    ...
    capabilities: ['brand scrape', 'customer research', 'atomic customer switch', 'stable hosted demo images', 'RTDB demo configuration', 'customer restore'],
...
export const MCP_WORKFLOWS = Object.freeze({
  customer_demo: {
    ...
    steps: [
      ...
      'Use lab_demo_customer_switch to preview RTDB plus all five managed images, then obtain one confirmation before apply.',
