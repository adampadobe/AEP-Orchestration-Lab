const READ_ONLY_TOOLS = new Set([
  ...
  'lab_creativity_capabilities',
  'lab_creativity_access_probe',
  'lab_creativity_photoshop_edit_preview',
  'lab_creativity_indesign_merge_preview',
  'lab_creativity_substance_render_preview',
  'lab_creativity_express_documents',
  'lab_creativity_express_document_get',
  'lab_creativity_express_variation_preview',
  'lab_creativity_illustrator_trace_preview',
