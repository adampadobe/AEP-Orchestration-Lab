...
(function () {
  ...
  function bind(config) {
    ...
    const recentIndustryFilterEl = ids.recentIndustryFilter ? $(ids.recentIndustryFilter) : null;
    ...
    window.addEventListener('aep-profile-infra-status-updated', (ev) => {
      ...
      const flags = payload && payload.industries ? payload.industries[industryKey] : null;
      if (!flags) return;
