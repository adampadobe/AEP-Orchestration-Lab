...
(function attachLabEnvBar(global) {
  ...
  var DEFAULT_VERSIONS = {
    ...
    assets: {
      ...
      spectrumCss: '20260625-s2-status-prefs',
      demoEnvStripSpectrum: '20260625-s2-markup',
      demoEnvStrip: '20260625-s2-markup',
      spectrumSync: '20260625-s2-status-light',
      compactJs: '20260625-s2-tooltips',
      compactCss: '20260625-s2-status-light',
