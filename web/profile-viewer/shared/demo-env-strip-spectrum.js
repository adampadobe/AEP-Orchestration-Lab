...
(function attachDemoEnvStripSpectrum(global) {
  ...
  function siteCloneSpectrumFullMarkup(config) {
    ...
    return (
      ...
      '<div class="spectrum-env-stat spectrum-env-stat--ecid"><span class="spectrum-env-stat__label">ECID</span><strong id="aepSpectrumToolbarEcid" class="spectrum-env-ecid__value lab-env-chip lab-env-chip--ecid" aria-live="polite" title="Browser ECID">—</strong></div>' +
      '</div>' +
      ...
      '<button type="button" class="spectrum-env-icon-btn lab-env-config-btn" id="aepLabEnvMinimizeBtn" aria-label="Show environment configuration" aria-expanded="false" aria-pressed="false" title="Expand configuration panels">' +
      spectrumIcon('fileConvert') +
      '</button>' +
