...
(function attachDemoEnvStripSpectrum(global) {
  ...
  function siteCloneSpectrumFullMarkup(config) {
    ...
    return (
      ...
      '<button type="button" class="spectrum-env-icon-btn lab-env-minimize-btn" id="aepLabEnvMinimizeBtn" aria-label="Minimize configuration panels" aria-pressed="false" title="Minimize configuration panels (profile lookup stays visible)">' +
      '<svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true"><path fill="currentColor" d="M7.4 15.4 12 10.8l4.6 4.6 1.4-1.4-6-6-6 6 1.4 1.4Z"/></svg></button>' +
