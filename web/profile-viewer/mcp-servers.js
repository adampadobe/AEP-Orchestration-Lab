  ...
  const MCP_SERVERS = [
    {
      ...
      product: 'Complete Lab MCP · 174 tools',
    ...
    },
    {
      ...
      section: 'lab',
      dropdownLabel: 'Adobe Firefly generation',
      name: 'AEP Lab — Adobe Firefly generation',
      product: 'Focused governed MCP · 8 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/firefly',
      summary: 'A focused Adobe Firefly context for safely previewing, submitting, monitoring, and cancelling Image 5 and five-second Video jobs.',
      useCases: [
