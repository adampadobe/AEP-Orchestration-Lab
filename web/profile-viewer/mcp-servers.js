...
(function () {
  ...
  const MCP_SERVERS = [
    ...
    },
    {
      ...
      product: 'Focused governed MCP · 6 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/firefly',
      summary: 'A focused Adobe Firefly Image 5 context for safely previewing, submitting, monitoring, and cancelling text-to-image jobs.',
      useCases: [
        'Check Firefly readiness and supported aspect ratios',
        'Preview a prompt without consuming Firefly credits',
        'Submit one exactly confirmed Image 5 generation',
        'Monitor the asynchronous Adobe job and retrieve its image URL',
