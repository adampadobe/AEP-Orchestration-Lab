  ...
  const MCP_SERVERS = [
    {
      ...
      product: 'Complete Lab MCP · 202 tools',
    ...
    },
    {
      ...
      docUrl:
        'https://github.com/adampadobe/AEP-Orchestration-Lab/blob/main/tools/aep-lab-profile-mcp/README.md',
      docLabel: 'Entry point reference',
    },
    {
    ...
    },
    {
      ...
      product: 'Focused governed MCP · 19 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/commerce',
      summary:
        'A focused Adobe Commerce as a Cloud Service context for inspecting, building, validating, and safely cleaning up catalog-driven demos.',
      useCases: [
        'Verify the configured Commerce organization and ACCS instance',
        'Inspect stores, products, attributes, categories, assignments, inventory sources, and media',
        'Preview and explicitly confirm curated product, category, assignment, or inventory changes',
        'Audit exact deletion targets before a separately confirmed delete',
        'Discover and validate shopper-facing storefront data with guarded GraphQL queries',
      ],
      configNotes:
        'REST writes use a closed operation allowlist, fresh-state preflight IDs, exact confirmation, one non-retried request, and readback. Arbitrary REST calls and GraphQL mutations/subscriptions are rejected. Adobe credentials remain in Firebase Functions secrets.',
      connectionKind: 'Focused · governed writes',
      toolCount: 19,
      docUrl:
        'https://github.com/adampadobe/AEP-Orchestration-Lab/blob/main/tools/aep-lab-profile-mcp/README.md',
    ...
    },
    {
      ...
      product: 'Focused governed MCP · 15 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/commerce-optimizer',
      summary: 'A focused Adobe Commerce Optimizer context for storefront inspection and governed catalog ingestion during demo preparation.',
      useCases: [
        ...
        'Preview and submit products, metadata, categories, price books, prices, and product layers',
        'Audit exact deletion batches before separately confirmed submission',
      ],
      configNotes: 'Storefront queries require a public catalog view ID and remain read-only. Data ingestion uses a closed operation allowlist, bounded batches, preflight IDs, exact confirmation, and one non-retried request. Accepted changes index asynchronously and should be verified with the catalog-view tools. Adobe credentials and the instance endpoint remain in Firebase secrets.',
      connectionKind: 'Focused · governed writes',
      toolCount: 15,
    ...
    {
      id: 'aep-lab-firefly',
      configName: 'aep-lab-firefly',
      section: 'lab',
      dropdownLabel: 'Adobe Firefly creative media',
      name: 'AEP Lab — Adobe Firefly creative media',
      product: 'Focused governed MCP · 15 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/firefly',
      summary: 'A focused Adobe Firefly context for governed image, video, text-to-speech, transcription, captions, and dubbing workflows.',
      useCases: [
        'Check Firefly readiness and supported aspect ratios',
        'Preview a prompt without consuming Firefly credits',
        'Submit one exactly confirmed Image 5 or Video generation',
        'List voices and generate speech from a confirmed script',
        'Transcribe audio or video and optionally produce translated SRT captions',
        'Dub audio or video with optional video lip sync',
        'Monitor the asynchronous Adobe job and retrieve its asset URL',
        'Cancel one exact job when needed',
      ],
      configNotes: 'Firefly credentials stay in Cloud Run Secret Manager. Generation is billable and non-idempotent, so apply requires a hash-bound preview and exact confirmation and is never retried automatically.',
      connectionKind: 'Focused · governed generation',
      toolCount: 15,
      caution: true,
      docUrl: 'https://github.com/adampadobe/AEP-Orchestration-Lab/blob/main/tools/aep-lab-profile-mcp/README.md',
    ...
    {
      id: 'aep-lab-creativity',
      configName: 'aep-lab-creativity',
      section: 'lab',
      dropdownLabel: 'Adobe creative production',
      name: 'AEP Lab — Adobe creative production',
      product: 'Focused governed MCP · 16 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/creativity',
      summary: 'A focused production context for Photoshop v2, InDesign, Substance 3D, Adobe Express beta, and Illustrator APIs.',
      useCases: [
        'Combine auto tone, auto straighten, exposure, contrast, and saturation through Photoshop v2',
        'Merge CSV records into an InDesign template and produce personalised PDFs',
        'Render 3D product models with Substance 3D',
        'Inspect tagged Express templates and create text, image, video, PDF, or document variations',
        'Convert approved PNG/JPEG artwork to SVG with Illustrator Image Trace',
      ],
      configNotes: 'Lightroom-style edits use Adobe\'s unified Photoshop v2 endpoint. Processing applies require a hash-bound preview and exact confirmation and are never retried automatically. Token-only probes consume no creative processing credits. Firefly generation stays in the Firefly MCP; Express Review remains unimplemented until a public contract is verified.',
      connectionKind: 'Focused · governed production',
      toolCount: 16,
      caution: true,
      docUrl: 'https://github.com/adampadobe/AEP-Orchestration-Lab/blob/main/docs/ADOBE_API_CAPABILITY_ROADMAP.md',
      docLabel: 'Creative API capability and safety reference',
    },
    {
    ...
    },
    {
      ...
      configName: 'aep-lab-measurement-quality',
      section: 'lab',
      dropdownLabel: 'Measurement quality',
      name: 'AEP Lab — Measurement quality',
      product: 'Focused read-only MCP · 6 tools',
      mcpUrl: 'https://aep-lab-profile-mcp-109406613852.us-central1.run.app/mcp/measurement-quality',
      summary: 'Read-only diagnostics across Adobe Assurance event metadata, Tags properties and environments, and Adobe Status incidents.',
      useCases: [
        'Find a recent Assurance session and inspect event metadata',
        'Audit Tags extensions and rules for one exact property',
        'List development, staging, and production Tags environments',
        'Correlate a problem window with relevant Adobe Status incidents',
      ],
      configNotes: 'All tools are bounded and read-only. Raw Assurance payload values are omitted. A successful read is reported separately from connected-service or token evidence.',
      connectionKind: 'Focused · read-only',
      toolCount: 6,
      docUrl: 'https://github.com/adampadobe/AEP-Orchestration-Lab/blob/main/tools/aep-lab-profile-mcp/README.md',
    ...
    },
    {
      ...
      product: 'Focused Lab MCP · 15 tools',
