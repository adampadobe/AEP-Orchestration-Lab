  ...
  const MCP_SERVERS = [
    {
      ...
      product: 'Complete Lab MCP · 181 tools',
      ...
      configNotes:
        'Choose this key-based connection for broad work, first-run setup, infrastructure, Snowflake, or administration. The Coworker marketplace also installs all fourteen focused integrations.',
