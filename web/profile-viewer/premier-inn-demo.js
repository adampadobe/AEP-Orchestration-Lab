...
(function (global) {
  ...
  function run() {
    ...
    if (premierInnTagsInjection && window.envBar && typeof window.envBar.registerTagsInjection === 'function') {
      window.envBar.registerTagsInjection(premierInnTagsInjection);
    }
