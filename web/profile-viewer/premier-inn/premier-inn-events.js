 ...
 * hotel.booking.complete, hotel.booking.stayerIdentified (when booker ≠ stayer: complete uses booker shell email + ECID; stayerIdentified upserts stayer profile then uses returned profile ECID + stayer email when available, else email-only primary identity),
