...
(function () {
  ...
  function patchScrollIntoView() {
    if (Element.prototype.__armyBcScrollPatched) return;
    ...
    Element.prototype.__armyBcScrollPatched = true;
  }

  function patchFocus() {
    if (HTMLElement.prototype.__armyBcFocusPatched) return;
    ...
    HTMLElement.prototype.__armyBcFocusPatched = true;
  }
